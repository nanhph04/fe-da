        ...
        <div className="max-w-7xl mx-auto -mt-20 relative z-20">
          {releaseItems.length > 0 ? (
            ...
            <section className="py-8 px-8">
              <div className="rounded-sm border border-white/10 bg-[#1a1a1a]/80 p-8 text-white/60">
          ...
          {categories.length > 0 && (
            <section className="py-8 px-8">
              <div className="mb-6 flex items-center justify-between">
                <h2 className="text-xl font-bold font-headline text-white">Khám phá theo thể loại</h2>
              </div>
              <div className="flex flex-wrap gap-3">
                {categories.map(category => (
                  <Link
                    ...
                    className="rounded-sm border border-white/10 bg-[#1a1a1a] px-4 py-2 text-sm font-medium text-white/70 transition-colors hover:border-white/20 hover:bg-[#262626] hover:text-white"
                  >
                    {category.name}
                  </Link>
                ))}
