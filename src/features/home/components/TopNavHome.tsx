    ...
    <>
      <PublicHeader currentPath="/" subtitle="Public Marketing">
        <div className="hidden max-w-md flex-1 xl:flex">
          <Link
            href="/search"
            className="group relative flex h-11 w-full items-center rounded-sm border border-white/10 bg-card px-4 pl-10 text-sm text-white/70 transition-colors hover:border-white/20 hover:text-foreground"
          >
