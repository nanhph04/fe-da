export function WalletDashboard({ onWithdrawClick }: { onWithdrawClick: () => void }) {
  return (
      ...
      <div className="lg:col-span-2 bg-[#131315] rounded-xl border border-[#262528] p-8 flex flex-col justify-between relative overflow-hidden">
        ...
        <div>
           ...
           <div className="flex items-baseline gap-2">
             <h1 className="text-5xl md:text-6xl font-extrabold font-headline text-white">850,200</h1>
             <span className="text-2xl font-bold text-zinc-500">AC</span>
           </div>
           <p className="text-zinc-500 text-sm mt-2 font-medium">≈ 85,020,000 VND</p>
        </div>

        <div className="mt-12 flex gap-4">
          <button 
            onClick={onWithdrawClick}
            className="px-8 py-3 bg-[#ff8e80] hover:bg-[#ff7668] text-black font-bold font-headline text-sm rounded-sm shadow-lg shadow-[#ff8e80]/20 transition-all flex items-center gap-2"
          >
