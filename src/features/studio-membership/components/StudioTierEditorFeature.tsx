  ...
  return (
    <main className="mx-auto w-full max-w-4xl p-8">
      <section className="rounded-lg border border-border/30 bg-card p-8">
        ...
        <h1 className="font-headline text-3xl font-extrabold tracking-tight text-foreground">Tier editor moved</h1>
        <p className="mt-3 font-body text-sm leading-6 text-muted-foreground">
          Create and edit membership tiers from the connected membership management screen.
        </p>
        <Link
