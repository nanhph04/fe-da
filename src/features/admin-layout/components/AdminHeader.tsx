    ...
    <>
      ...
      <div className="flex items-center gap-3 md:gap-6">
        ...
        <button
          ...
          className="relative flex h-10 w-10 items-center justify-center rounded-sm text-muted-foreground transition-colors hover:bg-muted/60 hover:text-foreground focus:outline-none focus:ring-2 focus:ring-primary/40"
        >
            ...
            {mobileNavItems.map((item) => {
              ...
              return (
                <Link
                  ...
                  className={`flex min-h-11 items-center gap-3 rounded-sm border-r-2 px-4 py-2.5 text-sm transition-colors ${
                    isActive
